    ...
    <div class="custom-container">
        <div class="flex flex-row">
            <div class="basis-1/2">
                ...
                <div class="grid grid-flow-col mb-[10px]">
                    <div
                        class="w-[162px] pl-[11px] py-[14px] bg-white border border-[#0570DE] border-2 rounded-[4px] mr-[12px]">
                        <a href="#">
                    ...
                    <div
                        class="w-[162px] pl-[11px] py-[14px] bg-white border border-[#E0E0E0] border-2 rounded-[4px] mr-[12px]">
                        <a href="#">
                            <img src="{{ asset('images/card.jpg') }}" alt="">
                    ...
                    <div class="w-[40px] relative  bg-white border border-[#E0E0E0] border-2 rounded-[4px] mr-[12px]">
                ...
                <div class="grid grid-cols-2 gap-6 mb-[48px]">
                    <div>
                        <label for="countries"
            ...
            <div class="basis-1/2">
                <div class="ml-[24px] py-[14px] px-[17.5px] shadow-lg mt-[36px]">
